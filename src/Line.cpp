...
Line::Line(SDL_Renderer* renderer, int xstart, int ystart, int xend, int yend, ColorRGB color) : m_currentPoint(Point2D(xstart,ystart)),
...
Line::Line(SDL_Renderer*renderer, const Point2D & start, const Point2D & end, ColorRGB color) : Line(renderer, start.x, start.y, end.x, end.y, color)
{
}
